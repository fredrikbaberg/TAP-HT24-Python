...
class Country:
    ...
    def __str__(self):
        return "".join([f"I {self.__name} bor det {self.__population} miljoner invånare.",
        ...
        # return f"I {self.__name} bor det {self.__population} miljoner invånare." + (f" Arean är {self.__area} km^2" if self.__area is not None else "")
